...
<div class="container">
    ...
    @csrf
        <div class="mb-3">
            ...
            <input type="text" name="nama_matkul" id="nama_matkul" class="form-control" value="{{ old('nama_matkul') }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="angkatan" id="angkatan" class="form-control" value="{{ old('angkatan') }}" placeholder="Contoh: 2023" required>
        </div>
                ...
                success: function(response) {
                    ...
                    if (response.length > 0) {
                        $.each(response, function(index, kelas) {
                            $('#kelas_id').append(
                                `<option value="${kelas.kelas_id}">${kelas.nama_kelas} (Angkatan: ${kelas.angkatan})</option>`
                            );
                        });
                    } else {
